...
if __name__ == "__main__":
    ...
    speakers=  ['Alma María', 'Rosemary Okafor', 'Ige Behringer', 'Filip Traverse', 'Damjan Chapman', 'Wulf Carlevaro', 'Aaron Dreschner', 'Kumar Dahl', 'Eugenio Mataracı', 'Ferran Simen', 'Xavier Hayasaka', 'Luis Moray', 'Marcos Rudaski']
    with open('studio_speakers.json', 'r') as archivo:
        studio_speakers = json.load(archivo)
    title = "prueba"
    text="En un pequeño pueblo rodeado de montañas, la vida transcurre con tranquilidad. Los habitantes disfrutan de la belleza de la naturaleza y de la compañía de sus vecinos. Cada mañana, el sol asoma por el horizonte, pintando el cielo de colores cálidos. Mientras los niños juegan en la plaza, los ancianos se reúnen a contar historias del pasado. ¿Qué recuerdos te trae este lugar y cómo crees que ha cambiado con el tiempo?"
